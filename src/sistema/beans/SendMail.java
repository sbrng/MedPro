package com.example.myapplication.Down.Bean;
...
public class SendMail {
    private final String user = "medpro.suporte";
    private final String pass = "q4HwASN3gLX4i83";
    ...
    public void sendMail(String from, String to, String subject, String message) {
        ...
        try {
             ...
             */
            tr.connect(mailSMTPServer, user, pass);
